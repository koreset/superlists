...
class ItemModelTest(TestCase):
	def test_saving_and_retrieving_items(self):
		first_item = Item()
		first_item.text = "The first todo item"
		first_item.save()
		...
		self.assertEqual(first_saved_item.text, "The first todo item")
		self.assertEqual(second_saved_item.text, "The second todo item")
